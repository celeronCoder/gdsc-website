    ...
    <nav className="nav">
      <div className="logo">
        ...
        >
          <img
            ...
            alt="GDSC Vit Bhopal University"
          ></img>
          <img
            className="dark--mode"
            src={"/images/GDSC-logo-dark.png"}
            alt="GDSC Vit Bhopal University"
          ></img>
        </Link>
      </div>
      <div className="navigation">
        <ul className="menu--links">
          ...
          <Link className="menu" href={"/team"}>
            Team
          </Link>
          <Link className="menu" href={"/events"}>
            Events
          </Link>
          <Link className="menu" href={"/blog"}>
            Blog
          </Link>
          <Link className="menu" href={"/about"}>
            About
          </Link>
          <Link className="menu" href={"/contact-us"}>
            Contact Us
          </Link>
        </ul>
      </div>
      ...
      <div className="nav--btn">
        <form action="#">
          <label className="navigate">
            ...
            <img
              className="dot light--mode"
              src="https://img.icons8.com/ios-filled/50/null/menu-2.png"
              alt="menu"
            />
            <img
              className="dot dark--mode"
